...
class LedgerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessReceipts = channel.unary_unary(
                ...
                response_deserializer=ledger__pb2.ReceiptsResponse.FromString,
...
def add_LedgerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessReceipts': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=ledger__pb2.ReceiptsResponse.SerializeToString,
            ),
    }
...
class LedgerService(object):
    ...
    def ProcessReceipts(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ledger.LedgerService/ProcessReceipts',
            ledger__pb2.ReceiptsRequest.SerializeToString,
            ledger__pb2.ReceiptsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
